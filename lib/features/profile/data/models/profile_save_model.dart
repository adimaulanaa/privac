...
class ProfileSaveModel {
  ...
  @override
  String toString() => 'user(id: $id, name: $name, username: $username, biomatric_id: $biomatricId, face_id: $faceId, primary_key: $primaryKey, created_on: $createdOn, created_by: $createdBy, updated_on: $updatedOn, updated_by: $updatedBy)';
}
